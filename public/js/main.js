...
exo1.addEventListener('focusin', (event) => {
    event.target.style.background = 'blue'
})

// EXO 3

exo1.addEventListener('focusout', (event) => {
...
// let exo4 = document.getElementsByClassName('p').addEventListener("click")
// console.log(exo4);
// let text = exo4.replace("Mmm les tartines c'est délicieux");
// console.log(text);

// exo4.addEventListener('click', (event) => {
//     event.target.text.replace
// })
